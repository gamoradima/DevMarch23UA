define("UsrRealtyClassic1Page", [], function() {
	return {
		...
		diff: /**SCHEMA_DIFF*/[
			{
				"operation": "insert",
				"name": "UsrName811a93ba-bdb6-41eb-9841-69253575e638",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "FLOATce14864e-8988-4270-9082-aa4b436be6b2",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "FLOATa547ce5f-f9ea-4aaf-b534-5dd5d7705ab7",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "LOOKUP301a4cc0-daa6-4313-9d78-30ea60e04891",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 1,
